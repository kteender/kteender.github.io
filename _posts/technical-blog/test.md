...
<div class='captioned-image'>
    <img src='/img/2022-04-19-mocap/05_characterretargetwindow-1.png' style='max-width:max-content;'>
    <p>The above two images are the same source motion file. Top is the actors' performance, bottom is the Take that I created with the t-poses for characterization</p>
</div>
...
<div class='captioned-image'>
    <img src='/img/2022-04-19-mocap/06_characterplotting-2.png' style='max-width:max-content;'>
    <p>The above two images are the same source motion file. Top is the actors' performance, bottom is the Take that I created with the t-poses for characterization</p>
</div>
...
<div class='captioned-image'>
    <img src='/img/2022-04-19-mocap/11_actorfaceb-1.png' style='max-width:max-content;'>
    <p>The above two images are the same source motion file. Top is the actors' performance, bottom is the Take that I created with the t-poses for characterization</p>
</div>
